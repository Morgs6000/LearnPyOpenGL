...
def main():
    ...
    glTexParameter(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE) # observe que definimos o método de wrapping do container como GL_CLAMP_TO_EDGE
    glTexParameter(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE)

    # definir parâmetros de filtragem de textura
    glTexParameter(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST) # define a filtragem de textura como vizinho mais próximo para visualizar claramente os texels/pixels
    ...
    # --------------------------------------------------
    outShader.use() # não se esqueça de ativar/usar o shader antes de definir os uniforms!
