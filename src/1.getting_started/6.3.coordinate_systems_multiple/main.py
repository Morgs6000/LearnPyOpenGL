...
def main():
    ...
    while (not glfw.window_should_close(window)):
        ...
        projection = glm.perspective( # nota: atualmente definimos a matriz de projeção a cada quadro, mas, como ela raramente muda, geralmente é uma boa prática defini-la apenas uma vez, fora do loop principal.
            glm.radians(45.0), 
