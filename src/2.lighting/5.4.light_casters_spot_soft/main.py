...
def main():
    ...
    # --------------------------------------------------
    lightingShader = Shader("light_casters.vs", "light_casters.fs")
    ...
    while (not glfw.window_should_close(window)):
        ...
        lightingShader.setFloat("light.cutOff", cos(glm.radians(12.5)))
        lightingShader.setFloat("light.outerCutOff", cos(glm.radians(17.5)))
        lightingShader.setVec3("viewPos", camera.Position)

        # propriedades da luz
        lightingShader.setVec3("light.ambient", glm.vec3(0.1, 0.1, 0.1))
        ...
        lightingShader.setVec3("light.diffuse", glm.vec3(0.8, 0.8, 0.8))
