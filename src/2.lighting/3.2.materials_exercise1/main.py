...
def main():
    ...
    # --------------------------------------------------
    lightingShader = Shader("materials.vs", "materials.fs")
    ...
    while (not glfw.window_should_close(window)):
        ...
        # propriedades da luz
        lightingShader.setVec3("light.ambient", glm.vec3(1.0, 1.0, 1.0)) # observe que todas as cores de luz estão definidas com intensidade máxima
        lightingShader.setVec3("light.diffuse", glm.vec3(1.0, 1.0, 1.0))
        lightingShader.setVec3("light.specular", glm.vec3(1.0, 1.0, 1.0))

        # propriedades do material
        lightingShader.setVec3("material.ambient", glm.vec3(0.0, 0.1, 0.06))
        lightingShader.setVec3("material.diffuse", glm.vec3(0.0, 0.50980392, 0.50980392))
        lightingShader.setVec3("material.specular", glm.vec3(0.50196078, 0.50196078, 0.50196078)) # a iluminação especular não tem efeito total no material deste objeto
